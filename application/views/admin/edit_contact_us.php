<?php 
$banner = $this->AuthModel->fetch_main_page('contact_section');?>
            ...
            <div class="container-fluid">
                    ...
                    <div class="row">
                        <div class="col-3">
                            ...
                            <input type="hidden" class="form-control" id="table" name="table" value="contact_section"> 
                            <input type="hidden" class="form-control" id="redirect" name="redirect" value="contact-page">
                        ...
                        <div class="col-9">
                            <form role="form" method="post" action="<?=('update-cbanner-text');?>" enctype="multipart/form-data">
